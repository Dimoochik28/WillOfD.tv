document.addEventListener("DOMContentLoaded", () => {
  ...
  // === Відео за аніме ===
  const animeVideos = {
    onepiece: { 1: "Video/onepiece_trailer.mp4" },
    naruto: { 1: "Video/naruto_trailer.mp4" },
    boruto: { 1: "Video/boruto_trailer.mp4" },
    bleach: { 1: "Video/bleach_trailer.mp4" },
    drstone: { 1: "Video/drStone_trailer.mp4" },
    blackclover: { 1: "Video/blackclover_trailer.mp4" },
    vanitasnokarte: { 1: "Video/vanitasnokarte_trailer.mp4" },
    sololeveling: { 1: "Video/sololeveling_trailer.mp4" },
  };
